...
| Barcode / QR scanning | ✅ Present | The Scan page uses `@zxing/browser` to stream from the camera, decode barcodes, and admins can now disable the feature from settings which hides navigation and camera access for non-privileged users.【F:frontend/src/pages/Scan.jsx†L1-L79】【F:frontend/src/pages/Settings.jsx†L1356-L1495】【F:frontend/src/components/AppLayout.jsx†L1-L147】 |
| Developer data seeding | ✅ Present | Multi-factor protected developer endpoints accept JSON payloads to create products, locations, bins, and stock levels, with an admin UI to upload seed files or download a sample template.【F:backend/src/routes/developer.js†L1-L225】【F:frontend/src/pages/Settings.jsx†L120-L1707】 |
...
| Multi-location & bins | ✅ Present | The schema models locations, bins, and stock levels per bin, API responses aggregate per-location inventory, and the dedicated storage bins workspace exposes inline edit/create flows for operators.【F:backend/src/db.js†L32-L82】【F:backend/src/routes/stock.js†L12-L58】【F:frontend/src/pages/StorageBins.jsx†L1-L200】 |
| Serial/IMEI tracking | ✅ Present | Dedicated serial number models, reservation assignments, and REST endpoints provide end-to-end traceability that surfaces in the inventory UI.【F:backend/src/db.js†L68-L149】【F:backend/src/routes/serials.js†L1-L94】【F:frontend/src/pages/Inventory.jsx†L938-L1003】【F:frontend/src/pages/WorkOrders.jsx†L1-L214】 |
...
| RMA / faulty parts | ✅ Present | Faulty returns now create RMA cases linked to suppliers, serial numbers, and credits with live visibility in the inventory dashboard.【F:backend/src/db.js†L215-L252】【F:backend/src/routes/rma.js†L1-L113】【F:frontend/src/pages/Inventory.jsx†L1000-L1158】 |
...
3. **Automate supplier collaboration**: Extend purchasing and RMA flows with vendor notifications, expected-delivery tracking, and document uploads to close the loop with external partners.【F:backend/src/routes/purchasing.js†L1-L171】【F:backend/src/routes/rma.js†L1-L113】【F:frontend/src/pages/Inventory.jsx†L1000-L1158】
4. **Operational hardening**: Document and automate TLS termination, database backups, secret rotation, and observability (structured logs, Sentry) so reliability guidance lives alongside the new administration controls.【F:backend/src/app.js†L1-L41】【F:backend/src/config.js†L1-L30】【F:backend/src/startup/bootstrap.js†L5-L30】【F:frontend/src/pages/Settings.jsx†L1-L155】
