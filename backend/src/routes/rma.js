...
export default function createRmaRoutes(io) {
  ...
  router.get('/', requireAuth(['inventory','admin']), asyncHandler(async (_req, res) => {
  ...
  router.post('/:id/items', requireAuth(['inventory','admin']), asyncHandler(async (req, res) => {
  ...
  router.patch('/:id/status', requireAuth(['inventory','admin']), asyncHandler(async (req, res) => {
