...
export default function createPurchasingRoutes(io) {
  ...
  router.get('/suppliers', requireAuth(['admin','user','developer']), asyncHandler(async (_req, res) => {
  ...
  router.post('/suppliers', requireAuth(['admin','user','developer']), asyncHandler(async (req, res) => {
  ...
  router.get('/purchase-orders', requireAuth(['admin','user','developer']), asyncHandler(async (_req, res) => {
  ...
  router.post('/purchase-orders', requireAuth(['admin','user','developer']), asyncHandler(async (req, res) => {
  ...
  router.post('/purchase-orders/:id/receive', requireAuth(['admin','user','developer']), asyncHandler(async (req, res) => {
